...
/**
 * NameServer如何维护各个Broker的实时状态?,如何根据Broker的各种情况更新各种集群的属性数据?
 * 因为其他角色会主动向NameServer上报状态,所以NameServer的主要逻辑在DefaultRequestProcessor类中
 * 根据上报消息里的请求码做响应的处理,更新存储的对应信息
 * 此外连接断开的时间也会触发状态更新,具体逻辑在org.apache.rocketmq.namesrv.routeinfo.BrokerHousekeepingService类中
 *
 *
 */
